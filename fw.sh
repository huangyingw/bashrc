...
if [ -z "$3" ];
then
		find "$1" \( -name \.svn -o -name \.git -o -name \.hg \) -prune -o \( -name \*\.c -o -name \*\.cc -o -name \*\.h -o -name \*\.hpp -o -name \*\.cpp -o -name \*\.sh -o -name \*\.py -o -name YBUILD -o -name [m,M]akefile \) -exec grep -wnH  "$2" {} \;
else
